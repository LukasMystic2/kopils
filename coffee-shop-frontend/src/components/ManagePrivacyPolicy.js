...
const ManagePrivacyPolicy = ({ showNotification }) => {
    ...
    useEffect(() => {
        const fetchPrivacyPolicy = async () => {
            try {
                ...
                if (!response.ok) throw new Error('Gagal mengambil kebijakan privasi.');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!response.ok) throw new Error('Gagal memperbarui kebijakan privasi.');
            showNotification('Kebijakan Privasi berhasil diperbarui! 🛡️');
        } catch (error) {
            showNotification(error.message, 'error');
        } finally {
